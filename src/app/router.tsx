...
const Bills = lazy(() => import('@/features/bills/page'));
const BillsAction = lazy(() => import('@/features/bills/page/form'));
const DisplayBill = lazy(() => import('@/features/bills/page/view'));
...
export const protectedRoutes: Routes[] = [
  ...
  },
  {
    ...
    children: [
      { path: '', element: <Bills /> },
      { path: ':id', element: <BillsAction /> },
      { path: ':id/display', element: <DisplayBill /> },
    ],
  },
];
